...
document.querySelector("#cards").innerHTML = 
   ...
   createCard("22/11", "terça", createGame(0.3, 1, "C", "argentina", "1 x 2", "saudiarabia") + createGame(0.3, 0.3, "D", "denmark", "0 x 0", "tunisia") + createGame(0.3, 0.3, "C", "mexico", "0 x 0", "poland") + createGame(1, 1, "D", "france", "16:00", "australia")) +
